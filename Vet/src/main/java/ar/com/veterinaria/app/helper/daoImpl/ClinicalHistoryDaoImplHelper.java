...
import ar.com.veterinaria.app.helper.daoImpl.contract.ClinicalHistoryContractDaoImplHelper;

@Service
public class ClinicalHistoryDaoImplHelper implements ClinicalHistoryContractDaoImplHelper {

	private static final Logger logger = LoggerFactory.getLogger(ClinicalHistoryDaoImplHelper.class);
	...
	@Override
	public ClinicalHistory update(JpaRepository<ClinicalHistory, Integer> repository, Integer id,
