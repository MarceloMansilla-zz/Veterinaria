...
import ar.com.veterinaria.app.helper.daoImpl.contract.AddressContractDaoImplHelper;

@Service
public class AddressDaoImplHelper implements AddressContractDaoImplHelper {

	private static final Logger logger = LoggerFactory.getLogger(AddressDaoImplHelper.class);
